...
TOPIC_KO: dict[str, str] = {
    ...
    "talk": "잡담",
    "number": "숫자",
    # 달 이름만 있던 `month` 와 `weekday` 를 여기로 합쳤다. 사용자가 그렇게 말했다 —
    # "날짜 부분은 1월부터 12월까지밖에 안 나오는 게 아쉽다". 날짜를 말하려면 요일과
    # 오늘·내일, 시각까지 한자리에 있어야 한다.
    "date": "날짜·시간",
    # 옛 이름. 이 이름으로 저장된 행이 남아 있어도 화면에 영어가 뜨지 않게 남겨 둔다.
    "month": "날짜·시간",
    "weekday": "날짜·시간",
    "ordinal": "순서",
}
